...
//  https://www.hackerearth.com/practice/data-structures/arrays/1-d/practice-problems/algorithm/biased-chandan/description/
...
int main()
{
    ...
    int num;
    int sum=0;   // count-> to sum the ratings
                          // temp-> to store the previous no
